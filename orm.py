...
get_user_musigma_team_global_from_id = db.prepare("SELECT * FROM musigma_team_global WHERE user_id = $1")
update_user_musigma_team_global = db.prepare("UPDATE musigma_team_global SET mu = $2, sigma = $3 WHERE user_id = $1")
create_user_musigma_team_global = db.prepare("INSERT INTO musigma_team_global (user_id, mu, sigma) VALUES ($1, $2, $3) RETURNING id")
